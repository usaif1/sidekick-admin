...
const Scooters: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"All" | "Active" | "Dormant" | "Servicing">("All");
    ...
    return (
        ...
        <div>
                ...
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-x-2 mt-2">
                        <button
                            ...
                            className={`${baseTabStyles} ${activeTab === "All"
                        ...
                        <button
                            ...
                            className={`${baseTabStyles} ${activeTab === "Active"
                                    ? "bg-tabs-primary text-black"
                                    : "bg-gray-100 text-gray-800 hover:bg-gray-200"
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`${baseTabStyles} ${activeTab === "Dormant"
                                    ? "bg-tabs-primary text-black"
                                    : "bg-gray-100 text-gray-800 hover:bg-gray-200"
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`${baseTabStyles} ${activeTab === "Servicing"
                                    ? "bg-tabs-primary text-black"
                                    : "bg-gray-100 text-gray-800 hover:bg-gray-200"
                                }`}
                        >
            ...
            <div className="flex justify-between w-full mt-6">
                <div>
                    "Click on Scooter to check its status."
                </div>

                <div>
                <button className=" text-[16px] leading-[100%] font-semibold tracking-[0] font-[Plus_Jakarta_Sans]  gap-3 rounded-[90px] px-5 py-3 bg-[#18f27a]"> Export</button>
                </div>
            </div>
        </div>
    );
